...
export default function Resume() {
  ...
  const resumeUrl = "./Samsul_Alom_Laskar.pdf" // Place your resume.pdf in the public folder
      ...
      <section className={`py-20 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gray-900" : "bg-white"}`}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className={`text-4xl sm:text-5xl font-bold mb-6 ${isDark ? "text-white" : "text-gray-900"}`}>Resume</h2>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className={`text-4xl sm:text-5xl font-bold mb-6 ${isDark ? "text-white" : "text-gray-900"}`}>
            <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Resume</span>
          </h2>
          <p className={`text-xl max-w-3xl mx-auto ${isDark ? "text-gray-300" : "text-gray-600"}`}>
            View and download my professional resume
          </p>
        ...
        <div className="space-y-8">
          ...
          <div className={`rounded-2xl shadow-xl overflow-hidden ${isDark ? "bg-gray-800" : "bg-white"}`}>
            <div
              className={`p-4 border-b flex items-center justify-between ${isDark ? "border-gray-700 bg-gray-700" : "border-gray-200 bg-gray-50"}`}
            >
              <div className="flex items-center">
                <FileText className={`h-5 w-5 mr-2 ${isDark ? "text-gray-300" : "text-gray-600"}`} />
                <span className={`font-medium ${isDark ? "text-white" : "text-gray-900"}`}>Samsul_Alom_Laskar.pdf</span>
              </div>
            ...
            <div className="relative">
              {!pdfError ? (
                ...
                <div
                  className={`flex flex-col items-center justify-center h-[400px] ${isDark ? "text-gray-300" : "text-gray-600"}`}
                >
                  <FileText className="h-16 w-16 mb-4 opacity-50" />
                  <h3 className="text-xl font-semibold mb-2">PDF Preview Not Available</h3>
                  <p className="text-center mb-6 max-w-md">
                    The PDF preview couldn't be loaded. You can still download the resume or view it in a new tab.
                  </p>
                  <div className="flex gap-4">
                    ...
                    <button
                      onClick={handleViewInNewTab}
                      className={`inline-flex items-center px-6 py-3 rounded-lg font-medium border transition-colors duration-200 ${isDark
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className={`p-6 rounded-xl shadow-sm ${isDark ? "bg-gray-800" : "bg-white"}`}>
              <div className="text-center">
                ...
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  3.5+ years of full-stack development experience with modern technologies
                </p>
              </div>
            </div>
            ...
            <div className={`p-6 rounded-xl shadow-sm ${isDark ? "bg-gray-800" : "bg-white"}`}>
              <div className="text-center">
                ...
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  Expertise in React, Node.js, TypeScript, and modern web development
                </p>
              </div>
            </div>
            ...
            <div className={`p-6 rounded-xl shadow-sm ${isDark ? "bg-gray-800" : "bg-white"}`}>
              <div className="text-center">
                ...
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                  Computer Science degree and industry certifications
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={`text-center p-8 rounded-2xl ${isDark ? "bg-gray-800" : "bg-gray-50"}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className={`inline-flex items-center justify-center px-8 py-4 rounded-lg font-semibold border transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl ${isDark
                  ? "bg-gray-700 text-white border-gray-600 hover:bg-gray-600"
                  : "bg-white text-gray-900 border-gray-200 hover:border-gray-300"
                  }`}
              >
